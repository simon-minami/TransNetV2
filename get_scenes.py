...
def create_output_video(input_video, output_path, scene_boundaries):
...
if __name__ == "__main__":
    ...
    input_video = "C:/Users/simon/OneDrive/Desktop/senior ds capstone/TransNetV2/videos/WVU_BUFF_test.mp4"
    # txt_file = 'videos/OREGON_WASHST_test.mp4.scenes.txt'
    txt_file = "C:/Users/simon/OneDrive/Desktop/senior ds capstone/TransNetV2/videos/WVU_BUFF_test.mp4.scenes.txt"
    output_path = 'hi.mp4'

    scene_boundaries = read_scene_boundaries(txt_file)
    create_output_video(input_video, output_path, scene_boundaries)
